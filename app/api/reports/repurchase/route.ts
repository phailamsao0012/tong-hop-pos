...
// Mua lại & Upsell: với mỗi đơn mua thành công trong kỳ (theo ngày tạo), đếm số đơn thành công
// trước đó của cùng SĐT trong POS (toàn bộ lịch sử đã lưu). 0 = mua lần đầu, 1 = Upsell lần 1, ...
type Row = {
