...
export async function GET(request: Request) {
  ...
  const ctes = `
    WITH source AS (
      SELECT id,pos_id,seller_id,seller_assigned_at,first_confirmed_at,
      ...
      SELECT id,pos_id,seller_id,seller_assigned_at,first_confirmed_at,closer_id,current_total,
