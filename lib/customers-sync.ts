 ...
 */
export async function syncCustomersRecent(db: D1Database, shop: { id: string; shop_id: string | null; customers_synced_at?: string | null }, apiKey: string, maxPages = 8, fullNotesCap = 25) {
  const now = new Date();
